...
<div class="wp-block-group alignfull te-sec-steps" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:heading {"align":"wide"} -->
...
<div class="wp-block-group"><!-- wp:paragraph {"className":"te-step-num"} -->
<p class="te-step-num"><?php echo (int) $i + 1; ?></p>
<!-- /wp:paragraph -->
