...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'tenny-leads' ),
				'storm'       => __( 'Storm or hail damage', 'tenny-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'tenny-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'tenny-leads' ),
				'not-sure'    => __( 'Vet inte än', 'tenny-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'tenny-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'tenny-leads' ),
				'research' => __( 'Jag kollar bara priser', 'tenny-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'tenny-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'tenny-leads' ),
		'contacted' => __( 'Kontaktad', 'tenny-leads' ),
		'quoted'    => __( 'Quote sent', 'tenny-leads' ),
		'won'       => __( 'Won', 'tenny-leads' ),
		'lost'      => __( 'Lost', 'tenny-leads' ),
		'spam'      => __( 'Misstänkt spam', 'tenny-leads' ),
	);
}
