 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'Tenny AB' );
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'tenny/page-replacement' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'tenny/quote-funnel' ),
...
<p class="has-large-font-size">Tenny AB är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om Tenny AB', $about_content . "\n\n" . nps_pattern( 'tenny/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'tenny/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder Tenny AB uppgifterna du skickar med offertformuläret.' );
